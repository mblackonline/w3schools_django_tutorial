"""
Django settings for cd_tech_backend project.
...
ALLOWED_HOSTS = ['127.0.0.1']  # you will need to add your IP address or Domain Name here to run in production
...
ROOT_URLCONF = 'cd_tech_backend.urls'
